        ...
        >
          <div className="space-y-6">
            ...
            <div className="text-center mb-6">
              <h2 className="text-xl font-bold text-gray-900 mb-2">CAMPUSKINECT TERMS OF SERVICE</h2>
              <p className="text-sm text-gray-600">Last Updated: September 27, 2025</p>
            </div>
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">1. PROHIBITED CONTENT</h3>
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">3. CONTENT MODERATION</h3>
              <p className="text-gray-700 mb-3 font-medium">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">4. REPORTING MECHANISM</h3>
              <p className="text-gray-700 mb-3 font-medium">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">5. USER BLOCKING</h3>
              <p className="text-gray-700 mb-3 font-medium">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">6. ENFORCEMENT ACTIONS</h3>
              <p className="text-gray-700 mb-3 font-medium">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">7. PRIVACY AND DATA</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4 mb-4">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">8. PLATFORM SAFETY</h3>
              <p className="text-gray-700 mb-3 font-medium">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">9. PLATFORM COMPLIANCE</h3>
              <p className="text-gray-700 mb-3 font-medium">
            ...
            <section>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">12. AGREEMENT</h3>
