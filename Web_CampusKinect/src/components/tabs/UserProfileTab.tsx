...
const UserProfileTab: React.FC<UserProfileTabProps> = ({ userId }) => {
  ...
  const handleSendMessage = () => {
    // Navigate directly to chat page with this user
      ...
      <div className="bg-white rounded-xl shadow-lg border-2 border-gray-300 p-6 mb-6">
        <div className="flex items-start space-x-6">
          ...
          <div className="flex-shrink-0">
            {(isOwnProfile && (currentUser?.profileImage || currentUser?.profilePicture)) || user.profilePicture ? (
              <img
                src={(isOwnProfile && (currentUser?.profileImage || currentUser?.profilePicture)) || user.profilePicture}
