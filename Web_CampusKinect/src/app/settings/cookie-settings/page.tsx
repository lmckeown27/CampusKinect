...
export default function SettingsCookieSettingsPage() {
    ...
    <MainLayout>
      <div className="min-h-screen" style={{ backgroundColor: '#525252' }}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="rounded-2xl shadow-xl p-8 border" style={{ backgroundColor: '#737373', borderColor: '#708d81' }}>
            <div className="prose prose-lg max-w-none text-center">
              <div className="space-y-8">
                {/* Introduction */}
                <section>
                  <h3 className="text-xl font-semibold text-white mb-4 text-center">Introduction</h3>
                ...
                {/* Essential Cookies */}
                <section>
                  <h3 className="text-xl font-semibold text-white mb-4 text-center">Essential Cookies</h3>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="ml-6">
                      <input
                        ...
                        disabled
                        className="w-6 h-6 bg-gray-100 border-gray-300 rounded cursor-not-allowed"
                        style={{ accentColor: '#708d81' }}
                      />
                    </div>
                  </div>
                </section>
                ...
                {/* Analytics Cookies */}
                <section>
                  <h3 className="text-xl font-semibold text-white mb-4 text-center">Analytics Cookies</h3>
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex-1">
                      <p className="text-gray-300 leading-relaxed mb-4">
                    ...
                    <div className="ml-6">
                      <input
                        ...
                        className="w-6 h-6 bg-gray-100 border-gray-300 rounded cursor-pointer"
                        style={{ accentColor: '#708d81' }}
                      />
                    </div>
                  </div>
                ...
                {/* Functional Cookies */}
                <section>
                  <h3 className="text-xl font-semibold text-white mb-4 text-center">Functional Cookies</h3>
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex-1">
                      <p className="text-gray-300 leading-relaxed mb-4">
                ...
                <section>
                  <h3 className="text-xl font-semibold text-white mb-4 text-center">How to Manage Cookies</h3>
                  
                  <h4 className="text-lg font-medium text-white mb-3 text-center">Browser Settings</h4>
                  <p className="text-gray-300 leading-relaxed mb-4">
                  ...
                  <h4 className="text-lg font-medium text-white mb-3 text-center">Mobile Devices</h4>
                  <p className="text-gray-300 leading-relaxed mb-4">
                  ...
                  <h4 className="text-lg font-medium text-white mb-3 text-center">Third-Party Tools</h4>
                  <p className="text-gray-300 leading-relaxed mb-4">
                ...
                {/* Cookie Preferences */}
                <section>
                  <h3 className="text-xl font-semibold text-white mb-4 text-center">Your Cookie Preferences</h3>
                  <p className="text-gray-300 leading-relaxed mb-4">
                ...
                {/* Action Buttons */}
                <section>
                  <h3 className="text-xl font-semibold text-white mb-4 text-center">Save Your Preferences</h3>
                  ...
                  {/* Success Message */}
                  {showSuccess && (
                    <div className="mb-6 border rounded-lg p-4" style={{ backgroundColor: '#166534', borderColor: '#86efac' }}>
                      <div className="flex items-center space-x-2">
                        <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#86efac' }}></div>
                        <p className="font-medium" style={{ color: '#d1fae5' }}>Cookie preferences saved successfully!</p>
                      </div>
                    </div>
                  )}
                ...
                <section>
                  ...
                  <div className="rounded-lg p-4 mt-4" style={{ backgroundColor: '#525252', border: '2px solid #708d81' }}>
                    <p className="text-white font-medium">CampusKinect Cookie Team</p>
