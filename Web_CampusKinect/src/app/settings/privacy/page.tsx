        ...
        <div className="border-b" style={{ backgroundColor: '#737373', borderColor: '#708d81' }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex items-center justify-between relative">
              ...
              <h1 className="text-2xl font-bold text-white absolute left-1/2 transform -translate-x-1/2">Privacy Policy</h1>
              <div></div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <div className="rounded-lg p-4 mt-4" style={{ backgroundColor: '#525252', border: '2px solid #708d81' }}>
                    <p className="text-white font-medium">CampusKinect Privacy Team</p>
