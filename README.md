...
A modern, responsive web application for the CampusKinect student community platform. Built with Next.js, React, and TypeScript.
...
**Built with ❤️ by the CampusKinect Team**
